(function(){function key(row,name){return row.getAttribute("data-sort-"+name)||"";}
function compare(a,b,name,kind,dir){var av=key(a,name);var bv=key(b,name);var c;if(kind==="number"){var an=parseFloat(av);var bn=parseFloat(bv);var aNaN=isNaN(an);var bNaN=isNaN(bn);if(aNaN&&bNaN)return 0;if(aNaN)return 1;if(bNaN)return-1;c=an<bn?-1:an>bn?1:0;}else{c=av<bv?-1:av>bv?1:0;}
return dir==="desc"?-c:c;}
